...
import ank.com.secretchatlab.data.roster.AccountRosterListener;
...
public abstract class ConnectionItem {
    ...
    @NonNull
    private final ank.com.secretchatlab.data.connection.ConnectionListener connectionListener;
    ...
    public ConnectionItem(boolean custom,
        ...
        connectionListener = new ank.com.secretchatlab.data.connection.ConnectionListener(this);
