...
public class GroupManager implements OnLoadListener, OnAccountRemovedListener,
     ...
     */
    public static final String IS_ROOM = "ank.com.secretchatlab.data.IS_ROOM";

    /**
     * Reserved group name for active chat group.
     */
    public static final String ACTIVE_CHATS = "ank.com.secretchatlab.data.ACTIVE_CHATS";

    /**
     * Reserved group name to store information about group "out of groups".
     */
    public static final String NO_GROUP = "ank.com.secretchatlab.data.NO_GROUP";

    /**
     * Group name used to store information about account itself.
     */
    public static final String IS_ACCOUNT = "ank.com.secretchatlab.data.IS_ACCOUNT";
    ...
    static {
        try {
            ...
            NO_ACCOUNT = AccountJid.from("ank.com.secretchatlab@data/NO_ACCOUNT");
