...
import ank.com.secretchatlab.data.extension.attention.AttentionManager;
import ank.com.secretchatlab.data.extension.blocking.BlockingManager;
import ank.com.secretchatlab.data.extension.blocking.OnBlockedListChangedListener;
import ank.com.secretchatlab.data.extension.file.FileUtils;
...
import ank.com.secretchatlab.data.extension.muc.RoomState;
...
import ank.com.secretchatlab.data.message.NewMessageEvent;
import ank.com.secretchatlab.data.message.NotificationState;
import ank.com.secretchatlab.data.message.RegularChat;
...
import ank.com.secretchatlab.data.roster.OnChatStateListener;
...
import ank.com.secretchatlab.presentation.mvp.contactlist.UpdateBackpressure;
import ank.com.secretchatlab.ui.adapter.ChatViewerAdapter;
import ank.com.secretchatlab.ui.color.ColorManager;
import ank.com.secretchatlab.ui.color.StatusBarPainter;
import ank.com.secretchatlab.ui.dialog.AttachDialog;
...
import ank.com.secretchatlab.ui.helper.NewContactTitleInflater;
import ank.com.secretchatlab.ui.helper.PermissionsRequester;
import ank.com.secretchatlab.ui.preferences.ChatContactSettings;
...
import static ank.com.secretchatlab.ui.adapter.ChatViewerAdapter.PAGE_POSITION_CHAT_INFO;
import static ank.com.secretchatlab.ui.adapter.ChatViewerAdapter.PAGE_POSITION_RECENT_CHATS;
...
public class ChatActivity extends ManagedActivity implements OnContactChangedListener,
    ...
    private static final String ACTION_ATTENTION = "ank.com.secretchatlab.data.ATTENTION";
    private static final String ACTION_RECENT_CHATS = "ank.com.secretchatlab.data.RECENT_CHATS";
    private static final String ACTION_SPECIFIC_CHAT = "ank.com.secretchatlab.data.ACTION_SPECIFIC_CHAT";

    public static final String EXTRA_OTR_REQUEST = "ank.com.secretchatlab.data.EXTRA_OTR_REQUEST";
    public static final String EXTRA_OTR_PROGRESS = "ank.com.secretchatlab.data.EXTRA_OTR_PROGRESS";
//    public static final String ACTION_OTR_REQUEST = "ank.com.secretchatlab.data.ACTION_OTR_REQUEST";
//    public static final String ACTION_OTR_PROGRESS = "ank.com.secretchatlab.data.ACTION_OTR_PROGRESS";
    ...
    private static final String SAVE_SELECTED_PAGE = "ank.com.secretchatlab.ui.activity.ChatActivity.SAVE_SELECTED_PAGE";
    private static final String SAVE_SELECTED_ACCOUNT = "ank.com.secretchatlab.ui.activity.ChatActivity.SAVE_SELECTED_ACCOUNT";
    private static final String SAVE_SELECTED_USER = "ank.com.secretchatlab.ui.activity.ChatActivity.SAVE_SELECTED_USER";
    private static final String SAVE_EXIT_ON_SEND = "ank.com.secretchatlab.ui.activity.ChatActivity.SAVE_EXIT_ON_SEND";
    ...
    private static AccountJid getAccount(Intent intent) {
        ...
        String stringExtra = intent.getStringExtra("ank.com.secretchatlab.data.account");
        if (stringExtra == null) {
            return null;
        }
    ...
    private static UserJid getUser(Intent intent) {
        ...
        String stringExtra = intent.getStringExtra("ank.com.secretchatlab.data.user");
        if (stringExtra == null) {
            return null;
        }
